...
public class EditProfileUserPage {
  ...
  private By selectorPermissionsDisabled = By.xpath("//*[@id='select-permissions'][contains(@class,'disabled')]");
  ...
  private By root = By.xpath("//*[@id='root']");
  ...
  public EditProfileUserPage(WebDriver driver) {
    this.driver = driver;
  }
  ...
  public void clickSaveButton() {
    try {
      ...
      wait.until(ExpectedConditions.visibilityOfElementLocated(buttonSave));
      WebElement button = driver.findElement(buttonSave);
      WebElement page = driver.findElement(root);
      Actions move = new Actions(driver);
      move.moveToElement(page).click().build().perform(); //moved the focus to the main page
      Thread.sleep(1000);
      button.click();
    } catch (Throwable e) {
      ExtentTestManager.getTest().log(Status.INFO, e);
  ...
  public void generateRandomFirstName(int length) {
  ...
  public boolean SelectorPermissionsDisabled() {
    try {
      WebDriverWait wait = new WebDriverWait(driver, 5);
      wait.until(ExpectedConditions.visibilityOfElementLocated(selectorPermissionsDisabled));
      WebElement selector = driver.findElement(selectorPermissionsDisabled);
