...
public class HomePage {
  ...
  private By leagueSectionNames = By.xpath("//*[@data-id='leaguesSection']//h6");
  private By leagueSectionVideos = By.xpath("//*[@data-id='leaguesSection']//*[@data-id='videos']");
  private By leagueSectionVideosTitle = By.xpath("//*[@data-id='leaguesSection']//*[@data-id='videoTitle']");
  private By leagueSectionVideosTime = By.xpath("//*[@data-id='leaguesSection']//*[@data-id='videoPublishedDate']");
  private By leagueSectionVideoTitle = By.xpath("(//*[@data-id='leaguesSection']//*[@data-id='videoTitle'])[1]");
  private By leagueSectionVideo = By.xpath("(//*[@data-id='leaguesSection']//*[@data-id='video']//*[@data-id='clipVideo'])[1]");
  private By leagueVideoPaused = By.xpath("(//*[@data-id='leaguesSection']//*[@data-id='video'])[1]//*[@class='video-react-play-control video-react-control video-react-button video-react-paused']");
  private By leagueVideoPlayPauseBtn = By.xpath("(//*[@data-id='leaguesSection']//*[@class='video-react-control-bar video-react-control-bar-auto-hide']//button[1])[1]");
  private By leagueVideoBigPlayBtn = By.xpath("//*[name()='svg'][contains(@class,'video__play-button pointer')]");
  private By leagueVideoTimer = By.xpath("(//*[contains(text(),'0:03')])[1]");//3 seconds count
  private By leagueSectionName = By.xpath("(//*[@data-id='leaguesSection']//h6)[1]");


  private By liveSectionTitle = By.xpath("//*[@data-id='liveSection']//*[contains(text(),'LIVE NOW')]");
  private By highlightsSectionTitle = By.xpath("//*[@data-id='liveSection']//*[contains(text(),'Recent Highlights')]");
  private By liveBadge = By.xpath("(//*[@data-id='liveBadge'])[1]");
  private By buttonMore = By.xpath("(//*[@data-id='viewMoreButton'])[1]");
  private By liveOrHighlightsTitle = By.xpath("(//*[@data-id='liveSection']//h6)[1]");
  private By liveOrHighlightsVideos = By.xpath("(//*[@data-id='liveSection'])[1]//*[@data-id='videos']//*[@data-id='video']");

  private By liveOrHighlightsVideo = By.xpath("((//*[@data-id='liveSection'])[1]//*[@data-id='video'])[1]");
  private By liveOrHighlightsVideoTitle = By.xpath("((//*[@data-id='liveSection'])[1]//*[@data-id='videoTitle'])[1]");
  private By liveOrHighlightsVideoTime = By.xpath("((//*[@data-id='liveSection'])[1]//*[@data-id='videoPublishedDate'])[1]");
  private By bookmarkIcon = By.xpath("//*[@data-id='bookmarkIcon']");
  private By toastBookmarkSuccess = By.xpath("//*[@class='Toastify__toast Toastify__toast--success']");
  private By toastBookmarkSuccessClose = By.xpath("//*[@class='Toastify__close-button Toastify__close-button--success']");
  ...
  public boolean ScheduleTeamLogoDisplayed() {
    driver.manage().timeouts().implicitlyWait(5, SECONDS);
    List<WebElement> scheduleTeamLogo = driver.findElements(scheduleTeamLogotype);
  ...
  public boolean ScheduleLiveLabelDisplayed() {
    ...
    try {
      ...
      wait.until(ExpectedConditions.visibilityOfElementLocated(scheduleLiveLogo));
  ...
  public boolean ScheduleScrollable() {
    ...
    Boolean verticalScroll = (Boolean) javascript.executeScript("return document.documentElement.scrollHeight>document.documentElement.clientHeight;");
  ...
  public boolean LeagueSectionVideoDescription() {
    driver.manage().timeouts().implicitlyWait(5, SECONDS);
    List<WebElement> leagueVideoDescription = driver.findElements(leagueSectionVideosTitle);
  ...
  public boolean LiveHighlightsVideoDescription() {
    try {
      ...
      WebElement description = driver.findElement(liveOrHighlightsVideoTitle);
  ...
  public boolean LeagueSectionVideoTime() {
    driver.manage().timeouts().implicitlyWait(5, SECONDS);
    List<WebElement> leagueVideoTime = driver.findElements(leagueSectionVideosTime);
  ...
  public void LeagueVideoHover(String browserType) {
    try {
      WebDriverWait wait = new WebDriverWait(driver, 5);
      wait.until(ExpectedConditions.visibilityOfElementLocated(leagueSectionVideo));
  ...
  public void LiveVideoHover(String browserType) {
    try {
      WebDriverWait wait = new WebDriverWait(driver, 5);
      wait.until(ExpectedConditions.visibilityOfElementLocated(liveOrHighlightsVideo));
  ...
  public void clickVideoPlay() {
    WebDriverWait wait = new WebDriverWait(driver, 5);
    wait.until(ExpectedConditions.visibilityOfElementLocated(leagueVideoBigPlayBtn));
  ...
  public void clickVideoPause() {
    ...
    try {
      WebDriverWait wait = new WebDriverWait(driver, 5);
      wait.until(ExpectedConditions.visibilityOfElementLocated(leagueVideoPlayPauseBtn));
  ...
  public int LeagueSectionVideosCount() {
    try {
      ...
      wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(leagueSectionVideos));
  ...
  public boolean HighlightsTitleDisplayed() {
    try {
      driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
      WebElement highlightsTitle = driver.findElement(highlightsSectionTitle);
  ...
  public int LiveHighlightsVideosCount() {
    try {
      List<WebElement> count = driver.findElements(liveOrHighlightsVideos);
      WebDriverWait wait = new WebDriverWait(driver, 10);
      wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(liveOrHighlightsVideos));
  ...
  public String LeagueSectionVideoTitleText() {
    try {
      WebDriverWait wait = new WebDriverWait(driver, 5);
      wait.until(ExpectedConditions.presenceOfElementLocated(leagueSectionVideoTitle));
  ...
  public void clickBookmarkToastClose() {
    try {
      WebDriverWait wait = new WebDriverWait(driver, 10);
      wait.until(ExpectedConditions.visibilityOfElementLocated(toastBookmarkSuccessClose));
